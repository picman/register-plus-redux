...
if (!class_exists('RPR_Dashboard_Widget')) {
	class RPR_Dashboard_Widget {
		...
		public function rpr_dashboard_setup(): void
		{
		 ...
		 * @return void
		 */
		public function rpr_invitation_tracking_widget(): void
		{
			global $wpdb;
			...
			foreach ($invitation_code_bank as $invitation_code) {
				...
				echo '<h3>', esc_html($invitation_code), ': <small>', sprintf(__('%s Users Registered.', 'register-plus-redux'), $user_count), '</small></h3>';
			}
		}
	}
}
